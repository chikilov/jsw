...
(function ($) {
	...
	var defaults = {
		 ...
		 */
		'maps': [{'path': 'floorplan.svg', 'id': 'map.1', 'title': '제목'}],
		/**
		 * @typedef path
		 * @memberOf wayfinding
		 * @typedef {object}
	...
	$.fn.wayfinding = function (action, options, callback) {
		...
		function makePin(x, y, type) {
			...
			if (type == 'startPin') {
				polyg = document.createElementNS('http://www.w3.org/2000/svg', 'polygon'); 
				polyg0 = document.createElementNS('http://www.w3.org/2000/svg', 'path'); 
				pin = document.createElementNS('http://www.w3.org/2000/svg', 'path');
				pin2 = document.createElementNS('http://www.w3.org/2000/svg', 'path');
				
				symbolPath = '612 214.2 634 229.2 612 244.2 612 214.2';
				symbolPath0 = 'M669,305.09l19.22,13.11L669,331.31V305.09m-1-1.89v30l22-15-22-15Z';
				symbolPath1 = 'M688.93,319.7a.44.44,0,0,1-.38-.21l-8.11-13.32a9,9,0,0,1-1-4.23,9.45,9.45,0,0,1,9.37-9.24h.13a9.55,9.55,0,0,1,6.68,2.68,9.14,9.14,0,0,1,2.82,6.62,9,9,0,0,1-1,4.2l-8.09,13.29A.45.45,0,0,1,688.93,319.7Zm.1-21.5a4,4,0,1,0,4,4A4,4,0,0,0,689,298.2Z';
				symbolPath2 = 'M688.93,293.2a9.05,9.05,0,0,1,6.33,2.54,8.66,8.66,0,0,1,2.67,6.26,8.55,8.55,0,0,1-.95,3.94l-8.05,13.22-8-13.22a8.41,8.41,0,0,1-1-4,9,9,0,0,1,8.87-8.74h.13m.1,13.5a4.5,4.5,0,1,0-4.5-4.5,4.51,4.51,0,0,0,4.5,4.5m-.1-14.5h-.14a10,10,0,0,0-9.86,9.74,9.6,9.6,0,0,0,1.08,4.49l8.11,13.32a1,1,0,0,0,1.62,0l8.11-13.32a9.48,9.48,0,0,0,1.08-4.43,9.64,9.64,0,0,0-3-7,10,10,0,0,0-7-2.82Zm.1,13.5a3.5,3.5,0,1,1,3.5-3.5,3.5,3.5,0,0,1-3.5,3.5Z';
				
				polyg.setAttribute('points', symbolPath);
				polyg.setAttribute('transform', 'translate(56 89)');
				polyg.setAttribute('class', 'st12');
				polyg0.setAttribute('fill', symbolPath);
				polyg0.setAttribute('class', 'st11');
				pin.setAttribute('d', symbolPath1);
				pin.setAttribute('fill', '#EF405C');
				pin.setAttribute('stroke', '#C72D46');
				pin2.setAttribute('d', symbolPath2);
				pin2.setAttribute('fill', '#C72D46');

				// indicator.appendChild(polyg);
				// indicator.appendChild(polyg0);
				// indicator.appendChild(pin);
				// indicator.appendChild(pin2);
				//indicator.setAttribute('transform', 'translate(-56 -89)');

			} else {
				pin = document.createElementNS('http://www.w3.org/2000/svg', 'path');
				pin2 = document.createElementNS('http://www.w3.org/2000/svg', 'path');
				
				symbolPath1 = 'M-7.3,11.5c0,0-0.1,0-0.2,0V3c0-9.7,0-9.7,0-9.8l0-0.7c0.1,0,0.2,0,0.2,0c0,0,0.1,0,0.2,0v0.9l0.4,0.1C-6-6.2-4.2-5.8-2.3-5.8c1.4,0,2.5-0.2,3.4-0.7C1.9-6.9,2.9-7.1,4-7.1c1.6,0,3.1,0.5,3.5,0.6v9.7C7,3,5.6,2.5,4,2.5c-1.2,0-2.2,0.2-3,0.7C0.2,3.6-0.9,3.8-2.3,3.8c-1.7,0-3.4-0.3-4.2-0.5l-0.6-0.1v8.3C-7.2,11.5-7.3,11.5-7.3,11.5z';
				symbolPath2 = 'M4-6.6c1.3,0,2.4,0.3,3,0.5v8.6C6.3,2.3,5.2,2,4,2C2.8,2,1.7,2.3,0.8,2.8C0,3.1-1,3.3-2.3,3.3C-4,3.3-5.7,3-6.4,2.8L-7,2.7C-7-2.6-7-4.9-7-6l0.2,0c0.7,0.2,2.6,0.6,4.6,0.6c1.5,0,2.7-0.2,3.6-0.7C2.1-6.4,3-6.6,4-6.6 M-7.3-8C-7.5-8-8-7.9-8-7.7v1c0,0,0,3.2,0,9.7v0.4v8.3c0,0.2,0.5,0.3,0.7,0.3c0.2,0,0.7-0.1,0.7-0.3V3.8C-5.8,4-4.1,4.3-2.3,4.3c1.4,0,2.6-0.2,3.5-0.7C2,3.3,2.9,3,4,3c1.9,0,3.5,0.6,3.5,0.6c0,0,0.1,0,0.1,0c0.1,0,0.1,0,0.2-0.1C7.9,3.6,8,3.5,8,3.4v-10C8-6.8,7.9-6.9,7.8-7C7.7-7,6-7.6,4-7.6c-1.2,0-2.3,0.2-3.1,0.7C0.1-6.5-1-6.3-2.3-6.3c-1.8,0-3.7-0.4-4.3-0.6v-0.8C-6.6-7.9-7.1-8-7.3-8L-7.3-8z';
				...
				indicator.appendChild(pin);
				indicator.appendChild(pin2);
				indicator.setAttribute('transform', 'translate(' + x + ' ' + (y - 10 * (height / 40)) + ') scale(' + height / 40 + ')');
			}
			...
			circle.setAttribute('stroke', '#c72d46');
			circle.setAttribute('stroke-width', '4.7');*/

			// var aaa, bbb, symbolPath1, symbolPath2;
			// aaa = document.createElementNS('http://www.w3.org/2000/svg', 'path');
			// bbb = document.createElementNS('http://www.w3.org/2000/svg', 'path');
			// pin.setAttribute('d', symbolPath);
			// 			pin.setAttribute('fill', '#ef405c');
			// 			pin.setAttribute('stroke', '#c72d46');
			// 			pin.setAttribute('stroke-width', '8.7');
...
//t수정
		...
		function animatePath(drawingSegment) {
            ...
            setTimeout(function () {
            	if ( drawing.length - 1 > drawingSegment ) {
            		var arrFloor = [
...
//                                      drawing[level][i+1].type = "L";
		...
		function replaceLoadScreen(el) {
			...
			//console.log($(maps[displayNum].title, el));
